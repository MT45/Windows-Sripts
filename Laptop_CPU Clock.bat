...
powercfg /setacvalueindex SCHEME_MIN SUB_PROCESSOR 893dee8e-2bef-41e0-89c6-b55d0929964c 0
powercfg /setacvalueindex SCHEME_MIN SUB_PROCESSOR bc5038f7-23e0-4960-96da-33abaf5935ec 64
powercfg /setdcvalueindex SCHEME_MIN SUB_PROCESSOR 893dee8e-2bef-41e0-89c6-b55d0929964c 0
powercfg /setdcvalueindex SCHEME_MIN SUB_PROCESSOR bc5038f7-23e0-4960-96da-33abaf5935ec 64

:: Apply changes
powercfg /changename SCHEME_BALANCED "Balanced" "System balanced power plan with 0-100% processor states"
powercfg /changename SCHEME_MIN "High performance" "High performance power plan with 0-64% processor states"
...
powershell -Command "$s=(New-Object -COM WScript.Shell).CreateShortcut(\"$env:USERPROFILE\Desktop\2.20-GHz.lnk\");$s.TargetPath='cmd.exe';$s.Arguments='/c powercfg /setactive SCHEME_MIN';$s.IconLocation=\"%SystemRoot%\System32\SHELL32.dll,27\";$s.Save()"
